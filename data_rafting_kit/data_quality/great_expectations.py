...
STANDARD_ARG_TYPES = {
    ...
    "value_pairs": (list[tuple[Any, Any]], Field(required=True, alias="values")),
    "value_pairs_set": (list[tuple[Any, Any]], Field(required=True, alias="values")),
    ...
    "regex_list": (str | list[str], Field(required=True, alias="regexs")),
